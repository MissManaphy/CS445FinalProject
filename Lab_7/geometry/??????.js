...
Camera.prototype.motion = function () {
    ...
    switch (mouseState.action) {
        case mouseState.actionChoice.TUMBLE:  // left mouse button
            ...
            var dy = -0.3 * mouseState.delx;  // angle around y due to mouse drag along x

            this.viewRotation = mult(rotateY(dy), this.viewRotation);
        ...
        case mouseState.actionChoice.TRACK:  // PAN   - right mouse button
            var dx = -0.3 * mouseState.dely; // amount to pan along x
        
            this.viewRotation = mult(rotateX(dx), this.viewRotation);
